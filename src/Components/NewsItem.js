...
const NewsItem = (props) => {
    ...
    return (
      <div>
        <div className="card" style={{backgroundColor: props.mode==='dark'?'#13466e':'white', color: props.mode==='dark'?'white':'#042743',maxHeight: '500'}}>
            ...
            <div className="card-body">
              ...
              <p className="card-text"><small style={{color: props.mode==='dark'?'Yellow':'green'}} >By {!author?"Unknown":author} At {publishedAt}</small></p>
